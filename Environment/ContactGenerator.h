...
class ContactGenerator {
 public:
  ...
  void generateManifolds(T x0,bool useCCD,std::vector<ContactManifold>& manifolds,std::set<ContactManifold>& manifoldsID,
    Mat3XT t,int status=STATIC_DYNAMIC|DYNAMIC_DYNAMIC);
